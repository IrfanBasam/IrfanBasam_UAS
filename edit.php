...
if ($simpan AND $id != "" AND $kode != "" AND $nama != "" AND $harga != "")
{
 ...
 try {
  ...
  $query = $conn->prepare("UPDATE barang_tersedia SET kode=:kode, nama_barang=:nama, harga_barang=:harga WHERE id=:id");
...
{
	try{
	 $query = $conn->prepare("SELECT * FROM barang_tersedia WHERE id=:id");
	 $query->bindParam(":id", $id);
	 $query->execute();
...
<div class="container">
	<div class="my-5">
 		<div class="row justify-content-center">
 			<div class="col-md-10">
 				<div class="card">
 					<div class="card-header text-center text-white" style="background-color: #191970; height: 45px">
              			...
              			<div class="card-body bg-light">
		                    ...
		                    <div class="col-sm-10">
		                    <input type="text" name="kode" class="form-control" placeholder="Kode Barang" value="<?php echo $data->kode; ?>" required>
		                    </div>
		                    </div>
		                    <div class="mb-3 row">
		                    ...
		                    <div class="col-sm-10">
		                    <input type="text" name="harga" class="form-control" placeholder="Harga Satuan" value="<?php echo $data->harga_barang; ?>" required>
		                    </div>
		                    </div>
							<div class="mb-3 row">
