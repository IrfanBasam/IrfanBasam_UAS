...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark ml-2" style="background-color: #ff8c00;">
  <div class="container-fluid">
    <a class="navbar-brand" href="?page=beranda">STORE</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        ?>
          <li class="nav-item">
          <a class="nav-link active" href="?page=input">Input Barang</a>
        </li>
        <li class="nav-item">
